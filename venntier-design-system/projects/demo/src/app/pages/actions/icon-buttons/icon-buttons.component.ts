  ...
  template: `
    <div class="demo-page">
      ...
      <section class="demo-section">
        ...
        <mat-card>
          <mat-card-header>
            <mat-card-title>Standard Icon Buttons</mat-card-title>
            <mat-card-subtitle>Standard icon buttons for common actions</mat-card-subtitle>
          </mat-card-header>
          <mat-card-content>
      ...
      <section class="demo-section">
        ...
        <mat-card>
          <mat-card-header>
            <mat-card-title>Icon Button Styles</mat-card-title>
            <mat-card-subtitle>Different visual styles for icon buttons</mat-card-subtitle>
          </mat-card-header>
          <mat-card-content>
      ...
      <section class="demo-section">
        ...
        <mat-card>
          <mat-card-header>
            <mat-card-title>Toggle Icon Buttons</mat-card-title>
            <mat-card-subtitle>Icon buttons that can be toggled between states</mat-card-subtitle>
          </mat-card-header>
          <mat-card-content>
            <div class="toggle-demo">
              <div class="toggle-group">
                ...
                <button
                  ...
                  [attr.aria-label]="
                    favoriteToggled() ? 'Remove from favorites' : 'Add to favorites'
                  "
                >
      ...
      <section class="demo-section">
        ...
        <mat-card>
          <mat-card-header>
            <mat-card-title>Icon Button States</mat-card-title>
            <mat-card-subtitle
              >Different states of icon buttons including disabled and loading</mat-card-subtitle
            >
          </mat-card-header>
          <mat-card-content>
      ...
      <section class="demo-section">
        ...
        <mat-card>
          <mat-card-header>
            <mat-card-title>Icon Button Colors</mat-card-title>
            <mat-card-subtitle>Icon buttons with different color themes</mat-card-subtitle>
          </mat-card-header>
          <mat-card-content>
      ...
      <section class="demo-section">
        ...
        <mat-card>
          <mat-card-header>
            <mat-card-title>Icon Button Groups</mat-card-title>
            <mat-card-subtitle
              >Groups of related icon buttons for toolbars and action bars</mat-card-subtitle
            >
          </mat-card-header>
          <mat-card-content>
