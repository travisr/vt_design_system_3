...
export class ElevationComponent {
  ...
  readonly elevationLevels = signal([
    ...
    },
    {
      value: 1,
      name: 'Subtle',
      shadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05), 0 1px 3px 0 rgba(0, 0, 0, 0.03)',
      shadowValue: '0 1px 2px 0 rgba(0, 0, 0, 0.05), 0 1px 3px 0 rgba(0, 0, 0, 0.03)',
      usage: 'OpenAI-style cards, subtle elevation',
    },
    {
      value: 2,
      name: 'Floating',
      shadow: '0 2px 4px 0 rgba(0, 0, 0, 0.08), 0 1px 2px 0 rgba(0, 0, 0, 0.05)',
      shadowValue: '0 2px 4px 0 rgba(0, 0, 0, 0.08), 0 1px 2px 0 rgba(0, 0, 0, 0.05)',
