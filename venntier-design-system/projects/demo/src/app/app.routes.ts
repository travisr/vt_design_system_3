...
export const routes: Routes = [
  ...
  // Foundation
  {
    path: 'foundation',
    children: [
      { path: 'typography', loadComponent: () => import('./pages/foundation/typography/typography.component').then(m => m.TypographyComponent) },
      { path: 'colors', loadComponent: () => import('./pages/foundation/colors/colors.component').then(m => m.ColorsComponent) },
      { path: 'spacing', loadComponent: () => import('./pages/foundation/spacing/spacing.component').then(m => m.SpacingComponent) },
      { path: 'motion', loadComponent: () => import('./pages/foundation/motion/motion.component').then(m => m.MotionComponent) },
      { path: 'icons', loadComponent: () => import('./pages/foundation/icons/icons.component').then(m => m.IconsComponent) },
    ]
  },
  ...
  // Actions
  {
    path: 'actions',
    children: [
      { path: 'buttons', loadComponent: () => import('./pages/actions/buttons/buttons.component').then(m => m.ButtonsComponent) },
      { path: 'fab', loadComponent: () => import('./pages/actions/fab/fab.component').then(m => m.FabComponent) },
      { path: 'icon-buttons', loadComponent: () => import('./pages/actions/icon-buttons/icon-buttons.component').then(m => m.IconButtonsComponent) },
      { path: 'segmented-buttons', loadComponent: () => import('./pages/actions/segmented-buttons/segmented-buttons.component').then(m => m.SegmentedButtonsComponent) },
      { path: 'chips', loadComponent: () => import('./pages/actions/chips/chips.component').then(m => m.ChipsComponent) },
    ]
  },
  ...
  // Forms
  {
    path: 'forms',
    children: [
      { path: 'text-fields', loadComponent: () => import('./pages/forms/text-fields/text-fields.component').then(m => m.TextFieldsComponent) },
      { path: 'select', loadComponent: () => import('./pages/forms/select/select.component').then(m => m.SelectComponent) },
      { path: 'checkboxes', loadComponent: () => import('./pages/forms/checkboxes/checkboxes.component').then(m => m.CheckboxesComponent) },
