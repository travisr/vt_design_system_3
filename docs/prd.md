...
$light-theme: (
  ...
  // Light gray background seen in panels
  ...
  // Main border color
  border-secondary: #f7f7f8,
  // Very subtle borders
  border-input: #d9d9e3,

  // Input field borders
  // Actions
  action-primary: #10a37f,
  // Green for primary CTAs only
  action-secondary: #000000,
  // Black secondary action
  action-hover: #f7f7f8,
  // Light gray hover background
  action-selected: #ececf1,
  // Darker gray for selected
  action-focus: #6e6e80,
  // Darker border/text on focus
...
$dark-theme: (
  ...
  action-selected: #2d2d3a,
  // Darker gray for selected
  action-focus: #9b9bab,
  // Lighter border/text on focus
...
```scss
$font-family-sans: 'Inter', 'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', Arial, sans-serif,
...
$dark-elevations: (
  ...
  3: 0px 4px 8px rgba(0, 0, 0, 0.4),
  4: 0px 6px 12px rgba(0, 0, 0, 0.45),
  5: 0px 8px 16px rgba(0, 0, 0, 0.5),
);
```
...
$card-config: (
  padding: 24px,
  // Generous padding seen in screenshots
  border-radius: 8px,
  ...
  sidenav:
    (
      ...
      active-item: (
        ...
        color: #000000,
        // Darkest text for selected
        font-weight: 500,
      ),
      hover-item: (
        background: #f7f7f8,
        // Lighter shade than selected
        color: #2d2d3a,
        // Darker than default gray
        font-weight: 400,
      ),
    ),
...
@Component({
  ...
  template: `
    <button mat-button [class]="buttonClass" [disabled]="disabled" [type]="type">
  ...
  @return mat.define-theme(
    (
      color: (
        ...
        // Will be overridden with tokens
...
// OpenAI-inspired color tokens for Angular Material 20
:root {
  // Primary colors (monochrome)
  --mat-sys-primary: #000000;
  --mat-sys-on-primary: #ffffff;
  --mat-sys-primary-container: #2d2d3a;
  --mat-sys-on-primary-container: #ffffff;

  // Secondary colors (green accent)
  --mat-sys-secondary: #10a37f;
  --mat-sys-on-secondary: #ffffff;
  --mat-sys-secondary-container: #e6f9f0;
  --mat-sys-on-secondary-container: #07624a;

  // Tertiary colors (purple for data viz)
  --mat-sys-tertiary: #8b5cf6;
  --mat-sys-on-tertiary: #ffffff;
  --mat-sys-tertiary-container: #f3efff;
  --mat-sys-on-tertiary-container: #3d1e8f;

  // Surface colors
  --mat-sys-surface: #ffffff;
  --mat-sys-on-surface: #000000;
  --mat-sys-surface-variant: #f7f7f8;
  --mat-sys-on-surface-variant: #6e6e80;
  ...
  // Outline
  --mat-sys-outline: #ececf1;
  --mat-sys-outline-variant: #d9d9e3;

  // Error, Warning colors
  --mat-sys-error: #ef4444;
  --mat-sys-on-error: #ffffff;
  --mat-sys-error-container: #fef2f2;
...
.dark-theme {
  ...
  --mat-sys-primary-container: #d9d9e3;
  --mat-sys-on-primary-container: #000000;

  --mat-sys-surface: #171717;
  --mat-sys-on-surface: #ffffff;
  --mat-sys-surface-variant: #212121;
  --mat-sys-on-surface-variant: #c5c5d2;

  --mat-sys-background: #000000;
  --mat-sys-on-background: #ffffff;

  --mat-sys-outline: #2d2d3a;
  --mat-sys-outline-variant: #565869;
}

// styles/tokens/_sys-typescale.scss
:root {
  // Display styles
  --mat-sys-typescale-display-large-font: 'Inter';
  ...
  // Headline styles
  --mat-sys-typescale-headline-large-font: 'Inter';
  --mat-sys-typescale-headline-large-size: 32px;
  --mat-sys-typescale-headline-large-line-height: 40px;
  --mat-sys-typescale-headline-large-weight: 500;

  // Body styles
  --mat-sys-typescale-body-large-font: 'Inter';
  --mat-sys-typescale-body-large-size: 16px;
  --mat-sys-typescale-body-large-line-height: 24px;
  --mat-sys-typescale-body-large-weight: 400;

  // Label styles
  --mat-sys-typescale-label-large-font: 'Inter';
  --mat-sys-typescale-label-large-size: 14px;
  --mat-sys-typescale-label-large-line-height: 20px;
  --mat-sys-typescale-label-large-weight: 500;
}
...
// Generate themes
$light-theme: core.create-vt-theme(
  $type: light,
);
$dark-theme: core.create-vt-theme(
  $type: dark,
);
...
@include mat.button-overrides(
  (
    ...
    outlined-hover-state-layer-color: var(--mat-sys-surface-variant),
    ...
    // Common tokens
    label-text-font: var(--mat-sys-typescale-label-large-font),
    label-text-size: var(--mat-sys-typescale-label-large-size),
    label-text-weight: var(--mat-sys-typescale-label-large-weight),
...
export class ThemeService {
  ...
  // Computed values
  readonly themeClass = computed(() => (this._isDarkMode() ? 'dark-theme' : 'light-theme'));
...
export class ResponsiveService {
  ...
  private readonly breakpointStates = Object.entries(this.breakpointQueries).reduce(
    (acc, [key, query]) => ({
      ...acc,
      [key]: toSignal(this.breakpointObserver.observe(query).pipe(map((result) => result.matches)), {
        initialValue: false,
      }),
    }),
  ...
  readonly isDesktop = computed(
    () => this.breakpointStates.md() || this.breakpointStates.lg() || this.breakpointStates.xl(),
  );
...
@Component({
  ...
  template: `
    <vt-card>
      <h2>Example Card</h2>
      <vt-button variant="primary" size="medium"> Primary Action </vt-button>
      <vt-button variant="secondary" size="medium"> Secondary Action </vt-button>
    </vt-card>
  `,
})
