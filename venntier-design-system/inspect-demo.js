  ...
  try {
    ...
    const buttonInfo = await page.evaluate(() => {
      ...
      allElements.forEach((el) => {
        if (
          el.className.includes('state') ||
          el.className.includes('ripple') ||
    ...
    console.log(
      'Button computed width/height:',
      buttonInfo?.computedStyle.width,
      buttonInfo?.computedStyle.height,
    );
    console.log('Button padding:', buttonInfo?.computedStyle.padding);
    console.log('Button margin:', buttonInfo?.computedStyle.margin);
    console.log('Button text content:', buttonInfo?.textContent);
